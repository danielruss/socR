...
soc2010_all <- codingsystem( readr::read_csv("https://danielruss.github.io/codingsystems/soc2010_all.csv"), name="soc2010")
...
soc1980_all <- codingsystem( readr::read_csv("https://danielruss.github.io/codingsystems/soc1980_all.csv",col_types = "cccccccc"), name="soc1980")
